...
==
#v(-2em)
#align(center,text(size: 18pt)[*Задача: Последовательности со строгими неравенствами*])
...
#pad(left: 1em)[#box(fill:luma(90%), outset:5pt, radius: 5pt)[Определение: $phi (n)={ 1 <= k <= n ∣ gcd(k,n)=1 }$]]
Свойства:
